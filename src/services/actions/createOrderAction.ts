...
import { TCreateOrderState } from "../reducers/createOrderReducer";
...
export const getOrder: ActionCreator<ThunkAction<void, TCreateOrderState, undefined, TCreateOrderActions>> = (ingredientsId: string[]) => {
  return function(dispatch: Dispatch<TCreateOrderActions>) {
    dispatch({
      type: GET_ORDER
    })
    fetch(`${api}/orders`, {
